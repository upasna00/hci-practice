...
<title>Over the Counter - Categories</title>
<link rel="shortcut icon" href="images/fav-icon.png" type="image/x-icon"/>
<link rel="stylesheet" type="text/css" href="css/cssotc-category-page.css" />
</head>
<body>
<div id="header">
	<div id="navBar">
...
<div class="container">
	<div id="heading">Over the Counter</div>
    <div id="first">
    	<div id="left">
        <br/>
        	<a href="#"><img src="images/otc-category-1.jpg" /></a>
        </div>
        <div id="right">
        	<br/>
        	<a href="otcProducts"><img src="images/otc-category2.jpg" /></a>
        </div>
    </div>
    <div id="first">
    	<div id="left">
        <br/>
        	<a href="#"><img src="images/otc-category-3.jpg" /></a>
        </div>
        <div id="right">
        	<br/>
        	<a href="#"><img src="images/otc-category-4.jpg" /></a>
        </div>
    </div>
</div>
<div class="clear"></div>
